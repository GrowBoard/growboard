...
export const DeleteConfirmDialog = ({
  ...
  return (
    <DialogContainer
      ...
      title={t('Plans.deleteConfirmTitle', 'Confirm Deletion')}
      maxW="md"
      footer={
    ...
    >
      <VStack gap={3} align="flex-start" py={2}>
        <Text fontSize="sm" color="text.primary">
          {t(
            'Plans.deleteConfirmDesc',
            'Are you sure you want to delete the plan "{{title}}"? This action cannot be undone.',
            { title },
          )}
        </Text>
        <Text
