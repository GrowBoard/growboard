...
/**
 * Filters the list of projects based on the search query.
 * Matches against title, subtitle, link, remark, owner, status, or tags.
 *
 * @param projects The list of projects.
 * @param query The search query.
 * @returns The filtered list of projects.
 */
export const filterProjects = (
  ...
  return projects.filter((item) => {
    ...
    const matchRemark = item.remark.toLowerCase().includes(cleanQuery);
    const matchOwner = item.owner.toLowerCase().includes(cleanQuery);
    const matchStatus = item.status.toLowerCase().includes(cleanQuery);
