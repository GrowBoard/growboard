...
export const DeleteConfirmDialog = ({
  ...
  return (
    <DialogContainer
      ...
      title={t('Resources.deleteConfirmTitle', 'Confirm Deletion')}
      maxW="md"
      footer={
    ...
    >
      <VStack gap={3} align="flex-start" py={2}>
        <Text fontSize="sm" color="text.primary">
          {t(
            'Resources.deleteConfirmDesc',
            'Are you sure you want to delete the resource "{{title}}"? This action cannot be undone.',
            { title },
          )}
        </Text>
