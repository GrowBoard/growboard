...
describe('PrivacyPolicy screen', () => {
  it('renders privacy policy sections correctly', () => {
    ...
    expect(
      screen.getByRole('heading', { name: /No Data Collection/i }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('heading', { name: /No Backend Servers/i }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('heading', { name: /Google OAuth/i }),
    ).toBeInTheDocument();
    expect(
      screen.getByRole('heading', { name: /Google Drive Access/i }),
    ).toBeInTheDocument();
    expect(
