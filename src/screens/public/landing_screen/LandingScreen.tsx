    ...
    const tick = () => {
      if (!document.hidden) {
        ...
        for (const s of stars) {
          ...
          ctx.fillStyle = `rgba(200,220,255,${s.o.toFixed(3)})`;
          ctx.fill();
        }
      }
...
const MODULES = [
  {
    ...
    rows: [
      { k: 'STRIPE_KEY', v: 'sk_live_51N…' },
      { k: 'DB_URL', v: 'postgres://…' },
      { k: 'AWS_SECRET', v: 'wJalrXUtnFE…' },
    ],
  },
  {
    id: 'expenses',
    ...
    rows: [
      { k: 'Rent & Utils', v: '₹18,500' },
      { k: 'Software Subs', v: '₹3,200' },
      { k: 'Travel', v: '₹4,800' },
    ],
  },
  {
    ...
    rows: [
      { k: 'Sprint Review', v: '30 Jun 14:00' },
      { k: 'Cloud Sync', v: '02 Jul 10:30' },
      { k: 'Q3 Launch', v: '15 Jul 09:00' },
    ],
  },
  {
    id: 'goals',
    ...
    rows: [
      { k: 'Clean TS codebase', v: '85%' },
      { k: 'Optimize LCP', v: 'Pending' },
      { k: 'Supabase RLS', v: 'Done ✓' },
    ],
  },
  {
    id: 'learnings',
    ...
    rows: [
      { k: 'TanStack Forms', v: 'Validators' },
      { k: 'Chakra v3', v: 'Theme Tokens' },
      { k: 'Row Level Sec.', v: 'Supabase' },
    ],
  },
  {
    id: 'resources',
    ...
    rows: [
      { k: 'Chakra UI Docs', v: 'chakra-ui.com' },
      { k: 'React Hook Form', v: 'rhf.com' },
      { k: 'Drive Assets', v: 'Google Drive' },
    ],
  },
] as const;
...
const SECURITY_POINTS = [
  {
    ...
    desc: 'GrowBoard collects absolutely no user data. No analytics, no tracking pixels, no telemetry. Your usage is invisible to us.',
  },
  {
    icon: LuLock,
    title: 'No Backend Servers',
    desc: "There is no GrowBoard server. Your data never leaves your browser and your Google Drive. We literally can't see it.",
  },
  {
    icon: LuHardDrive,
    title: 'Your Drive, Your Rules',
    desc: 'All data is stored as Google Sheets in your personal Google Drive. You own it, you control it, you can delete it anytime.',
  },
  {
    icon: LuServerOff,
    title: 'No Third-Party Sharing',
    desc: 'We share nothing with anyone. No APIs phone home, no cookies track sessions, no CDNs log requests. Period.',
  },
];
...
const GDRIVE_STEPS = [
  {
    ...
    desc: 'Sign in once with your Google account. GrowBoard uses OAuth 2.0 — your password is never shared with us.',
  },
  {
    num: '02',
    title: 'Data Stored as Sheets',
    desc: 'Every module (credentials, plans, expenses) maps to a Google Sheet in your Drive. Human-readable, exportable, yours.',
  },
  {
    num: '03',
    title: 'Offline-First Caching',
    desc: 'Zustand persists your workspace locally. Work offline, and changes sync back to Drive when you reconnect.',
  },
  {
    num: '04',
    title: 'Full Portability',
    desc: 'Leaving GrowBoard? Your data is already in Google Sheets. No vendor lock-in, no export needed.',
  },
];
...
const FEATURES = [
  {
    ...
    desc: 'Instant responsiveness with local Zustand state caching. Zero loading spinners on refresh.',
    accent: 'rgba(14,165,233,0.6)',
  },
  {
    icon: LuFolderGit2,
    title: 'Google Drive Sync',
    desc: 'Your data stays in your personal Google Drive. Full spreadsheet integration for absolute control.',
    accent: 'rgba(79,70,229,0.6)',
  },
  {
    icon: LuCompass,
    title: 'Stream Deck Widgets',
    desc: 'Modular productivity cards for credentials, expenses, plans, goals & learnings — tailored to you.',
    accent: 'rgba(139,92,246,0.6)',
  },
  {
    icon: LuShieldCheck,
    title: 'Privacy by Design',
    desc: 'No servers, no tracking, no data collection. Your workspace exists only in your browser and your Drive.',
    accent: 'rgba(16,185,129,0.6)',
  },
  {
    icon: LuRefreshCw,
    title: 'Seamless Sync',
    desc: 'Changes propagate bidirectionally between local cache and Google Sheets. Conflict-free, automatic.',
    accent: 'rgba(245,158,11,0.6)',
  },
  {
    icon: LuCode,
    title: 'Developer Ergonomics',
    desc: 'Built with React, Chakra UI, Zustand, and TypeScript. Clean architecture, fully typed, easy to extend.',
...
export const LandingScreen = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.getElementById('ld-css')?.remove();
    };
  }, []);
  ...
  const setRefs = useCallback(
    (node: HTMLDivElement | null) => {
      (mouseRef as React.MutableRefObject<HTMLDivElement | null>).current =
        node;
    ...
    >
      ...
      <Box position="fixed" inset={0} pointerEvents="none" zIndex={0}>
        ...
        <Box
          ...
          style={{
            background:
              'radial-gradient(circle at center, rgba(79,70,229,0.18) 0%, rgba(55,48,163,0.08) 40%, transparent 70%)',
            filter: 'blur(80px)',
            animation: 'ld-mesh-a 45s ease-in-out infinite',
        ...
        <Box
          ...
          style={{
            background:
              'radial-gradient(circle at center, rgba(14,165,233,0.14) 0%, rgba(2,132,199,0.06) 40%, transparent 70%)',
            filter: 'blur(90px)',
            animation: 'ld-mesh-b 55s ease-in-out infinite',
            willChange: 'transform',
          }}
        />
        <Box
          ...
          style={{
            ...
            filter: 'blur(70px)',
            animation: 'ld-mesh-c 38s ease-in-out infinite',
            willChange: 'transform',
          }}
        />
        <Box
          ...
          style={{
            background:
              'radial-gradient(circle 600px at var(--mx, 50vw) var(--my, 50vh), rgba(99,102,241,0.1), transparent 80%)',
          }}
        />
        <Box
          position="absolute"
          ...
          style={{
            ...
            animation: 'ld-noise 8s ease-in-out infinite',
          }}
        />
        <StarCanvas />
        <Box
        ...
        >
          <Box
            ...
            style={{
              ...
              animation: 'ld-shimmer 14s ease-in-out infinite',
              animationDelay: '2s',
            }}
          />
        </Box>
        ...
        >
          <Box
            ...
            style={{
              ...
              animation: 'ld-shimmer 18s ease-in-out infinite',
              animationDelay: '6s',
            }}
          />
        </Box>
      ...
      >
        ...
        >
          ...
          <HStack gap={3}>
            ...
            >
              {isLoggedIn
                ? t('Landing.goConsole', 'Go to Console')
      ...
      <Box position="relative" zIndex={10}>
        ...
        >
          ...
          <VStack
            ...
            style={{
              animation: 'ld-hero-up 0.9s cubic-bezier(0.22,1,0.36,1) both',
            }}
          >
            {/* Trust pills */}
            <HStack
            ...
            >
              {t(
                'Landing.heroTagline',
                'A Google Drive-first productivity workspace. No servers. No tracking. No data leaves your browser. Your credentials, plans, expenses, and goals live as Google Sheets in your personal Drive — fully portable, fully yours.',
              )}
            </Text>
            ...
            >
              <Button
                ...
                _hover={{
                  ...
                  boxShadow:
                    '0 8px 32px rgba(99,102,241,0.2), 0 0 0 1px rgba(99,102,241,0.15) inset',
          ...
          <Box
            ...
            style={{
              animation:
                'ld-slide-left 1s 0.15s cubic-bezier(0.22,1,0.36,1) both',
            }}
          >
            <Box
              ...
              _hover={{
                ...
                boxShadow:
                  '0 32px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(99,102,241,0.12) inset',
              }}
                ...
                <VStack align="stretch" gap={2}>
                  {mod.rows.map((row, i) => (
                    <Flex
                      ...
                      transition="all 0.2s"
                      style={{
                        animation: `ld-card-up 0.4s ${0.05 * i}s cubic-bezier(0.22,1,0.36,1) both`,
                      }}
                    >
                      <Text
                        fontSize="11px"
              ...
              return (
                <Box
                  ...
                  _hover={{
                    ...
                    boxShadow:
                      '0 12px 40px rgba(0,0,0,0.35), 0 0 0 1px rgba(16,185,129,0.06) inset',
                  }}
          ...
          >
            <Flex align="center" justify="center" gap={3} wrap="wrap">
              ...
              <Text
                ...
                textAlign="center"
              >
                No cookies · No analytics · No telemetry · No user data
                collected or shared — ever
              </Text>
            </Flex>
          </Box>
        </Box>
          ...
          >
            <Flex justify="center">
              ...
              >
                ...
                <Text fontSize="11px" color="rgba(79,70,229,0.6)">
                  →
                </Text>
                <Text
                  fontSize="11px"
        ...
        >
          <VStack gap={3} mb={14} textAlign="center" className="ld-reveal">
            ...
            <Text fontSize="sm" color="rgba(255,255,255,0.3)" maxW="lg">
              Every decision optimises for speed, privacy, and ergonomics — no
              compromises.
            </Text>
          </VStack>
        ...
        <Box maxW="1200px" mx="auto" px={6} py={{ base: 16, md: 24 }}>
          <VStack gap={6} textAlign="center" className="ld-reveal-scale">
            ...
            <Text fontSize="sm" color="rgba(255,255,255,0.35)" maxW="lg">
              Start organising your projects, credentials, and goals — with zero
              data leaving your browser. Free, private, no sign-up wall.
            </Text>
            <Button
              size="lg"
              px={10}
            ...
            >
              <HStack gap={2}>
                <Text>
                  {isLoggedIn ? 'Open Console' : "Get Started — It's Free"}
                </Text>
                <LuArrowRight size={16} />
              </HStack>
            </Button>
        ...
        >
          ...
          >
            <Text fontSize="12px" color="rgba(255,255,255,0.35)">
              {t(
                'Landing.copyright',
                '© 2026 GrowBoard. All rights reserved.',
                { year: 2026 },
              )}
            </Text>
            <HStack gap={5}>
