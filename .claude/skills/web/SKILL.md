...
- Developing or maintaining the GrowBoard React web application.
...
- "Implement a complex GrowBoard configuration grid using React and Chakra UI."
- "Set up a new route and screen for the GrowBoard app."
