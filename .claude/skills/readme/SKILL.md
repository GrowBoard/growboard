...
This skill defines the standards for creating, updating, and formatting README files across the GrowBoard repository. Maintaining clean, technically accurate, and easily readable documentation ensures developers and agents can quickly understand the system's architecture, dependencies, and entry points.
...
- Must start with a clear H1 representing the module name: `# GrowBoard [Module] (folder/)`
...
- Example:
  ...
  folder/
  ├── src/
  │   ├── index.tsx        # Entry point and bootstrap
...
- Example:
  ...
  |:---|:---|:---|
  | `react-router-dom` | 6.21.3 | Web framework and routing |
...
- For components: A props summary table containing Prop name, Type, Required status, and Description.
...
You **MUST** immediately update the corresponding module README. This requirement is enforced by the rule defined in [.claude/CLAUDE.md](file:///Users/mr.robot/z-stash/Growboard/growboard/.claude/CLAUDE.md).
